...
class _ExpensesState extends State<Expenses> {
  ...
  void _openAddExpenseOverlay() {
    //Basically it's a bottom sheet

    showModalBottomSheet(
      useSafeArea: true,
      // Does not overlap phone features such as camera for all devices
    ...
    return Scaffold(
      ...
      body: width < 600
          ...
          : Row(
              children: [
                Expanded(
                  // Takes as much height and width as it can get and not infinity
